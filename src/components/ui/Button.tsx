...
>(
	(
		...
		const computedClassName = cn(
			...
			radiusClass,
			disabled
				? "border-neutral-200 bg-neutral-200 text-neutral-400 shadow-none dark:border-neutral-800 dark:bg-neutral-800 dark:text-neutral-600"
				: colorClasses,
			groupSpacing,
			flexDirection,
			gapSize,
			isActiveState
				? "relative z-10 ring-2 ring-transparent ring-offset-1"
				: isGrouped
					? "z-0"
					: "",
			className,
