...
import { cn } from "@/components/utils/FlexTail-config";
...
export default function SignIn() {
  ...
  return (
    <Card className="flex max-w-xl mx-auto py-10 px-4 justify-center align-middle self-center items-center text-center">
      <CardHeader>
